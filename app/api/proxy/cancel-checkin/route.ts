...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('Sending payload for cancel-checkin:', JSON.stringify(responseData, null, 2))
    
    const response = await fetch('https://aperfectstay.ai/api/aperfect-pms/cancel-checkin', {
      method: 'POST',
      headers,
    ...
    console.log('proxy cancel-checkin successfully:', data)
